                      ...
                      <div className="filter-contents">
                        ...
                        <div className="filter-details">
                          ...
                          <div className="filter-grid">
                            ...
                            <div id="collapseone" className="show collapse">
                          ...
                          <div className="filter-grid">
                            ...
                            <div id="collapsetwo" className="show collapse">
                              <div className="filter-collapse">
                                <ul>
                                  <li>
                                    <label className="custom_check d-inline-flex">
                          ...
                          <div className="filter-grid">
                            ...
                            <div id="collapsethree" className="show collapse">
                              <div className="filter-collapse">
                          ...
                          <div className="filter-grid">
                            ...
                            <div id="collapsefour" className="show collapse">
                              <div className="filter-collapse">
                                <ul>
                                  <li>
                                    <label className="custom_check d-inline-flex">
                          ...
                          <div className="filter-grid">
                            ...
                            <div id="collapsefive" className=" show collapse">
                              <div className="filter-collapse">
                                <ul>
                                  <li>
                                    <label className="custom_check d-inline-flex">
                          ...
                          <div className="filter-grid">
                            ...
                            <div id="collapsesix" className="show collapse">
                              <div className="filter-collapse">
                                <ul>
                                  <li>
                                    <label className="custom_check d-inline-flex">
                          ...
                          <div className="filter-grid">
                            ...
                            <div id="collapseseven" className="show collapse">
                              <div className="filter-collapse">
                                <ul>
                                  <li>
                          ...
                          <div className="filter-grid">
                            ...
                            <div id="collapseeight" className="show collapse">
                              <div className="filter-collapse">
                                <ul>
                                  <li>
                                    <label className="custom_check d-inline-flex">
